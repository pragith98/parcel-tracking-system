...
function Alert({ type, message }: AlertProps) {
  ...
  if (isVisible && type === "ERROR") {
    return (
      <div className="w-full text-white bg-red-500 mt-10">
  ...
  if (isVisible && type === "SUCCESS") {
    return (
      <div className="w-full text-white bg-emerald-500 mt-10">
        <div className="container flex items-center justify-between px-6 py-4 mx-auto">
          <div className="flex">
            <svg viewBox="0 0 40 40" className="w-6 h-6 fill-current">
  ...
  if (isVisible) {
    return (
      <div className="w-full text-white bg-yellow-400 mt-10">
        <div className="container flex items-center justify-between px-6 py-4 mx-auto">
          <div className="flex">
            <svg viewBox="0 0 40 40" className="w-6 h-6 fill-current">
